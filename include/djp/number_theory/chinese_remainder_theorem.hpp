...
#ifndef DJP_NUMBER_THEORY_CHINESE_REMAINDER_THEOREM_HPP
#define DJP_NUMBER_THEORY_CHINESE_REMAINDER_THEOREM_HPP

#include <djp/number_theory/modular.hpp> // For mod_mul, mod_inverse
