...
#ifndef DJP_NUMBER_THEORY_SHANKS_FACTORIZATION_HPP
#define DJP_NUMBER_THEORY_SHANKS_FACTORIZATION_HPP

#include <djp/number_theory/euclid.hpp>      // For gcd
#include <djp/number_theory/square_root.hpp> // For isqrt, is_square
