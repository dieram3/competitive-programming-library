...
TEST(PointOrderTest, SortPointsInClockwiseOrder) {
  std::vector<point_i> points = {
      {1, 2}, {5, 5}, {6, 2},  {3, -2}, {3, 1}, {5, 5}, {2, 2},
      {1, 5}, {2, 3}, {4, 4},  {6, 2},  {6, 2}, {4, 6}, {3, 2},
      {1, 1}, {3, 0}, {3, -1}, {6, 6},  {4, 1}, {5, 4}, {2, 1}};

  std::vector<point_i> expected = {
      {4, 6},  {4, 4}, {5, 5}, {5, 5}, {6, 6}, {5, 4}, {6, 2},
      {6, 2},  {6, 2}, {4, 1}, {3, 2}, {3, 1}, {3, 0}, {3, -1},
      {3, -2}, {2, 1}, {2, 2}, {1, 1}, {1, 2}, {2, 3}, {1, 5}};
  point_i center = {3, 3};
  point_i start = {0, 1};
